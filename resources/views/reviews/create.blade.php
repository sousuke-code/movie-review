                ...
                <div class="flex flex-wrap -m-2">
                  <div class="p-2 w-full">
                    <div class="relative">
                      ...
                      <div type="text" id="name" name="name" value="{{ $user->name }}" class="w-full bg-white-300 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{$user->name}}
                    </div>
                    </div>
                  </div>
