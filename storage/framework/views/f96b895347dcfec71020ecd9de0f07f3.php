...
<?php $component->withAttributes([]); ?>
    <div class="mb-4 text-sm text-gray-600 font-semibold">
        <?php echo e(__('ご登録済みのメールアドレスに、リセット用のリンクをお送りします。ご希望の方は下記の欄にメールアドレスをご記入の上、送信してください')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'email','value' => __('登録メールアドレス')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'email','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('登録メールアドレス'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
