<section class="space-y-6">
    <header>
        <h2 class="text-lg font-medium text-gray-900">
            <?php echo e(__('アカウントを削除する')); ?>

        </h2>

        <p class="mt-1 text-sm text-gray-600">
            <?php echo e(__('一度削除したアカウントは、再び戻すことができません。ご確認の上削除処理をお願いします')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['x-data' => '','x-on:click.prevent' => '$dispatch(\'open-modal\', \'confirm-user-deletion\')']); ?><?php echo e(__('アカウントの削除')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
